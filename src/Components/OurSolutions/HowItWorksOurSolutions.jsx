  ...
  return (
    <div>
      <div id="home-solutions" className="mt-32 px-2 md:px-5 lg:w-10/12 lg:container mx-auto xl:w-10/12 2xl:w-8/12 2xl:container mx-auto 2xl:mt-32">
        ...
        <div id="our-solutions-header" className="text-center text-3xl mb-3 md:text-4xl lg:mb-14 lg:text-5xl font-semibold">
          <p>
            Our Solutions
          </p>
        </div>
        ...
        {/* section 1 */}
        <div id="section-1-text-left" className="flex flex-col-reverse md:flex-column md:items-start justify-between mb-14 lg:flex-row ">
        ...
        <div id="horizontal-rule" className="w-full h-px bg-gray-300 mb-20"></div>

        {/* section 2 */}
        <div id="section-2-text-right" className="flex flex-col md:flex-column items-start md:items-center justify-between mb-14 lg:flex-row ">
          <div id="image-part" className="w-full mb-6 md:w-10/12 lg:w-6/12">
        ...
        {/* section 3 */}
        <div id="section-3-text-left" className="flex flex-col-reverse md:flex-column md:items-start justify-between mb-14 lg:flex-row ">
          <div id="text-part" className="w-full md:w-10/12 lg:w-5/12 md:pr-10">
            <div id="title" className="capitalize text-xl lg:mb-3.5 lg:text-2xl font-semibold">
              <p>
        ...
        {/* section 4 */}
        <div id="section-4-text-right" className="flex flex-col md:flex-column items-center md:items-start justify-between mb-14 lg:flex-row ">
          <div id="image-part" className="w-full mb-6 md:w-10/12 lg:w-6/12">
        ...
        {/* section 5 */}
        <div id="section-5-text-left" className="flex flex-col-reverse md:flex-column md:items-start justify-between mb-14 lg:flex-row ">
          <div id="text-part" className="w-full md:w-10/12 lg:w-5/12 md:pr-10">
            <div id="title" className="capitalize text-xl lg:mb-3.5 lg:text-2xl font-semibold">
              <p>
        ...
        {/* section 6 */}
        <div id="section-6-text-right" className="flex flex-col md:flex-column items-center md:items-start justify-between mb-20 lg:flex-row ">
        <div id="image-part" className="w-full mb-6 md:w-10/12 lg:w-6/12">
...
export default HowItWorksOurSolutions;
