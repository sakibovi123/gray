...
import technicalExcellenceImageOurSolutions from "../../Assets/Images/technical-excellence-image-revolutionise-our-solutions.webp"

const RevolutioniseOurSolutions = () => {
  return(
    <div>
      <div id={"financial-benefits-section"} className={"mt-32 xl:mt-32 2xl:mt-40"}>
        ...
        <div className={"uppercase text-gray-600 text-lg text-center mb-6"}>
          <p>
            CLOUD BASE, AI-POWERED, SCALABLE
          </p>
        </div>

        <div id={"header"} className={"text-center text-slate-800 font-semibold text-3xl mb-20 lg:mb-24 lg:text-4xl "}>
          <p>
            Revolutionise the way your business works
          </p>
        </div>
        ...
        <div id={"process-automation-text-left"} className={"flex flex-col-reverse md:flex-column md:items-center justify-between mb-20 lg:flex-row xl:justify-evenly 2xl:justify-center"}>
          ...
          <div id={"image-part"} className={"w-full mb-2 md:w-10/12 lg:w-6/12 xl:w-5/12 2xl:w-4/12"}>
            <img src={technicalExcellenceImageOurSolutions} alt="" className={"rounded-xl mx-auto md:ml-0 md:mr-auto lg:mx-auto xl:mx-auto 2xl:py-3"} />
          </div>
        </div>
...
export default RevolutioniseOurSolutions;