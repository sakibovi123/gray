  ...
  return(
    <div id={"why-gray-section"} className={"px-2 sm:px-4 xl:w-10/12 xl:mx-auto 2xl:w-8/12 2xl:mt-56 2xl:mb-56"}>
      ...
      <div id={"header-section"} className={"text-center"}>
        <p className={"text-3xl text-slate-800 font-semibold mb-6 lg:text-5xl lg:mb-12 py-9"}>
        How to join us

        </p>

        <p className={"text-normal text-gray-600 mb-20"}>
        You can join us through our platform by emailing your CV (No recruitment agencies, please)
        </p>
      </div>
