...
import eCommerce from "../../Assets/Icons/health.webp"
import eCommerceImg from "../../Assets/Porfolio/ehealth.webp"


const Ehealth = ()=> {
    return (
        <div className="my-24">
            <h1 className="text-center text-5xl text-slate-700 font-bold">e-Health Portfolios</h1>
            ...
            <div className="flex flex-col items-start justify-center w-full md:w-[75%] p-7">
                    ...
                    <table className="border my-7 w-full">
                        ...
                        <a href="https://sarah.ggtasker.co.uk/" className="text-2xl font-bold text-slate-700">
                        Sarah
                        </a>
            </div>
