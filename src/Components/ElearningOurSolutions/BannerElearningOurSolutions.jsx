...
const BannerELearningOurSolutions = () => {
    return (
        <div id={"banner-elearning-our-solutions"} className={"bg-cover bg-center h-[570px] w-full"}>
            <div id={"text"} className={"container mx-auto md:w-[60%] text-left font-bold text-5xl md:text-7xl flex flex-col justify-center"}>
                <p className={"text-white md:w-[620px] my-32 md:my-32"}>
                    Tailor-made e-learning platform that works
                </p>
            </div>
        </div>
    );
...
export default BannerELearningOurSolutions;